          ...
          <CardContent className="px-8 pb-2">
            <Tabs value={tab} onValueChange={(v) => setTab(v as typeof tab)}>
              ...
              <TabsContent value="login">
                <form onSubmit={loginForm.handleSubmit(onLogin)} className="space-y-5 pt-6">
                  <div className="space-y-2">
                    ...
                    {loginForm.formState.errors.email && (
                      <p className="text-[10px] text-destructive">{loginForm.formState.errors.email.message}</p>
                    )}
                  </div>
                  <div className="space-y-2">
                  ...
                  >
                    {loginForm.formState.isSubmitting ? 'Signing in…' : 'Enter Dashboard'}
                  </Button>
                </form>
              </TabsContent>

              <TabsContent value="signup">
                <form onSubmit={signupForm.handleSubmit(onSignup)} className="space-y-5 pt-6">
                  <div className="space-y-2">
                    ...
                    {signupForm.formState.errors.full_name && (
                      <p className="text-[10px] text-destructive">{signupForm.formState.errors.full_name.message}</p>
                    )}
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                    ...
                    {signupForm.formState.errors.business_name && (
                      <p className="text-[10px] text-destructive">{signupForm.formState.errors.business_name.message}</p>
                    )}
                  </div>
                  <div className="space-y-2">
                    <Label className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
